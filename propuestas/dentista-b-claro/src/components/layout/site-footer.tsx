...
export function SiteFooter() {
  return (
    <footer className="mt-8 border-t border-border bg-[color-mix(in_oklch,var(--background),var(--stone)_35%)]">
      <Container className="py-16">
        <div className="grid gap-12 md:grid-cols-12">
          <div className="md:col-span-5">
            <Logo />
            <p className="mt-5 max-w-sm text-[0.95rem] leading-relaxed text-muted-foreground">
              Atelier dental en el barrio de Salamanca. Odontología de autor:
              precisión clínica, hospitalidad y resultados que no se anuncian.
            </p>
          ...
          <div className="md:col-span-2">
            ...
            <ul className="mt-4 space-y-2 text-sm">
              ...
              <li>
                <Link href="/cita" className="hover:text-primary">
                  Reservar cita
                </Link>
              </li>
              <li>
