  ...
  return (
    <>
      ...
      <Container className="max-w-3xl pb-24 text-[0.98rem] leading-relaxed text-muted-foreground">
        ...
        <p className="mt-3">
          Del formulario de hora: nombre, teléfono, email, motivo y notas. Se
        ...
        <p className="mt-3">
          ...
          la obligación de ficha clínica. Tratamos datos personales según la
        ...
        <p className="mt-3">
          ...
          gestionarlas. Puedes acceder, rectificar o cancelar tus datos
        ...
        <p className="mt-3">
          ...
          tratarán datos bajo contrato. No vendemos listados.
        </p>
      </Container>
    </>
  );
