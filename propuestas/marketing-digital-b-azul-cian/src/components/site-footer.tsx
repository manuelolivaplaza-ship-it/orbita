...
export function SiteFooter() {
  return (
    <footer className="border-t border-line bg-foam-2 pb-20 lg:pb-0">
      <div className="shell py-16 lg:py-20">
        <div className="grid gap-12 lg:grid-cols-12">
          <div className="lg:col-span-5">
            <Logo />
            <p className="mt-6 max-w-sm text-[16px] leading-relaxed text-muted">
              Agencia de marketing digital en Barrio Puerto, Valparaíso. Nueve
              cuentas. Pauta sin markup. Desde {site.founded}.
            </p>
            <p className="font-mono mt-8 text-[12px] tracking-wide text-navy">
              RUT {site.rut}
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-10 sm:grid-cols-3 lg:col-span-7">
            <div>
              <p className="mark mb-4">Estudio</p>
              <ul className="space-y-2.5 text-[15px]">
                ...
                <li>
                  <Link href="/mesa" className="link-line text-ink/80 hover:text-ink">
                    Mesa
                  </Link>
                </li>
                <li>
                  <Link href="/lectura" className="link-line text-ink/80 hover:text-ink">
                    Lectura
                  </Link>
                </li>
              </ul>
            ...
            <div>
              <p className="mark mb-4">Canales</p>
              <ul className="space-y-2.5 text-[15px]">
                {channels.map((item) => (
                  <li key={item.slug}>
                    <Link
            ...
            <div className="col-span-2 sm:col-span-1">
              <p className="mark mb-4">Puerto</p>
        ...
        <div className="mt-16 flex flex-col gap-3 border-t border-line pt-6 text-[12px] text-muted sm:flex-row sm:items-center sm:justify-between">
          ...
          <p className="flex flex-wrap gap-x-4 gap-y-1">
            ...
            <span>Si no sostiene, se apaga.</span>
          </p>
        </div>
      </div>
    </footer>
