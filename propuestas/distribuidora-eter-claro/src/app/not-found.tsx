  ...
  return (
    <div className="mx-auto flex min-h-[80svh] max-w-[1480px] flex-col justify-end px-5 pb-24 pt-40 md:px-10 lg:px-16">
      ...
      <h1 className="mt-6 max-w-2xl font-display text-6xl font-light tracking-tight md:text-8xl">
        Esta SKU no está en el CD.
      </h1>
      <p className="mt-6 max-w-md text-ink-soft">
        Puede que el pasillo esté mal escrito, o que el lote ya haya salido en
        la ronda. La carta sigue en su sitio.
      </p>
      <div className="mt-10 flex flex-wrap gap-3">
        ...
        <Link href="/lineas" className="btn btn-ghost">
          Ver las líneas
        </Link>
      </div>
    </div>
