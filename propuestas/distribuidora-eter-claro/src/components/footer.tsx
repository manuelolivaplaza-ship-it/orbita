...
export function Footer() {
  return (
    <footer className="border-t border-line bg-paper pb-20 md:pb-0">
      <div className="mx-auto grid max-w-[1480px] gap-14 px-5 py-20 md:grid-cols-12 md:px-10 lg:px-16">
        <div className="md:col-span-5">
          ...
          <p className="mt-5 max-w-sm text-sm leading-relaxed text-muted">
            Centro de distribución en Pudahuel. Seco, líquido y frío para cocina
            profesional. Una guía, tres temperaturas.
          </p>
        </div>
        ...
        <div className="md:col-span-3">
          ...
          <ul className="mt-5 space-y-3 text-sm text-ink-soft">
            ...
            <li>
              <Link href="/cuenta" className="trace">
                Abrir cuenta
              </Link>
            </li>
            <li>
      ...
      <div className="border-t border-line">
        <div className="mx-auto flex max-w-[1480px] flex-col gap-3 px-5 py-6 text-[0.68rem] uppercase tracking-[0.16em] text-muted md:flex-row md:items-center md:justify-between md:px-10 lg:px-16">
          <p>
          ...
          <p className="flex flex-wrap gap-4">
            ...
            <span>© {new Date().getFullYear()} · Pudahuel, Chile</span>
          </p>
        </div>
      </div>
    </footer>
