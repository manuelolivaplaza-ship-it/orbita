...
import { isHouseOpen, moonPhaseName, santiagoParts } from "@/lib/night";
...
export function OpenBadge() {
  ...
  useEffect(() => {
    const tick = () => setOpen(isHouseOpen());
    tick();
  ...
  return (
    <span
      ...
      title={open ? "La casa está abierta ahora" : "La casa abre a las 18:00"}
    >
      <span
