    ...
    <footer className="border-t border-line bg-luz-2 pb-24 lg:pb-0">
      <div className="shell py-16 lg:py-20">
        <div className="grid gap-12 lg:grid-cols-12">
          <div className="lg:col-span-5">
            ...
            <p className="mt-6 max-w-sm text-[16px] leading-relaxed text-muted">
              Estudio de marketing digital en Lastarria. Cinco personas. Señales
              claras para marcas que ya facturan. Desde {site.founded}.
            </p>
            <p className="mt-8 text-[13px] tracking-wide text-mar">
              RUT {site.rut} · Honorarios en UF + IVA
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-10 sm:grid-cols-3 lg:col-span-7">
            ...
            <div>
              <p className="kicker mb-4">Oficio</p>
              <ul className="space-y-2.5 text-[15px]">
                {services.map((item) => (
                  <li key={item.slug}>
                    <Link
        ...
        <div className="mt-16 flex flex-col gap-3 border-t border-line pt-6 text-[12px] text-muted sm:flex-row sm:items-center sm:justify-between">
          ...
          <p>El ruido es barato. La claridad se cobra.</p>
        </div>
      </div>
    </footer>
  );
