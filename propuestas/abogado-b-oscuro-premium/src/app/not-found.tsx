  ...
  return (
    <div className="shell flex min-h-[70svh] flex-col justify-center py-24">
      ...
      <h1 className="mt-4 max-w-[12ch] font-display text-[clamp(2.6rem,6vw,5rem)] leading-[0.92]">
        Esta pieza no está en el expediente.
      </h1>
      <p className="mt-5 max-w-[36ch] text-paper-dim">
        La página no existe o se movió. Vuelva al índice o pida la primera hora.
      </p>
      <div className="mt-8 flex flex-wrap gap-3">
        <Link href="/" className="btn btn-primary">
          Volver al inicio
        </Link>
        <Link href="/primera-hora" className="btn btn-ghost">
          Primera hora
        </Link>
      </div>
    </div>
