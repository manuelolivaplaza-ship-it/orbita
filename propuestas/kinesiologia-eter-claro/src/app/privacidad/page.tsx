      ...
      <section className="pb-24 lg:pb-32">
        <div className="shell max-w-3xl space-y-10 text-[16px] leading-relaxed text-tinta-suave">
          ...
          <div>
            ...
            <p className="mt-3">
              Nombre, RUT, correo, teléfono, previsión, comuna y el motivo de
              consulta que usted nos escribe al pedir hora. En la ficha clínica:
              historia, exámenes, plan. No vendemos listas. No hacemos marketing
              con su diagnóstico.
            </p>
          </div>
          <div>
            ...
            <p className="mt-3">
              ...
              pide, informar a su médico. La base es su consentimiento y la
              ejecución de un contrato de prestación de salud.
            </p>
          </div>
          <div>
            <h2 className="font-display text-[1.7rem] font-light text-tinta">
