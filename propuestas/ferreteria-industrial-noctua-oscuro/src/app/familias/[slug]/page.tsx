    ...
    <div className="pt-[4.5rem]">
      <section className="grid md:grid-cols-12">
        ...
        <div className="flex flex-col justify-between px-5 py-14 md:col-span-6 md:px-10 md:py-16 lg:px-16">
          <div>
            ...
            <h1 className="mt-5 font-display text-[clamp(2.6rem,5vw,5.2rem)] font-medium leading-[0.92] tracking-wide">
              {family.name}
            </h1>
          ...
          <dl className="mt-12 grid gap-6 sm:grid-cols-2">
            <div>
              ...
              <dd className="mt-2 font-display text-3xl font-medium tracking-wide">
            ...
            <div>
              ...
              <dd className="mt-2 text-steel">
                {family.corte ? "En nave, con medida escrita." : "No aplica."}
              </dd>
            </div>
          </dl>
        </div>
      ...
      <section className="mx-auto max-w-[1480px] px-5 py-20 md:px-10 md:py-28 lg:px-16">
        ...
        <Reveal className="mt-12">
          <Link href={`/cotizar?familia=${family.id}`} className="btn btn-sodium">
