...
export const metadata: Metadata = {
  title: "Familias",
  description:
    "Seis bahías de nave: fierro, pernos, planchas, soldadura, maderas y herramientas. Precio con IVA y stock rotulado.",
};
      ...
      <header className="mx-auto max-w-[1480px] px-5 py-16 md:px-10 md:py-24 lg:px-16">
        <Reveal>
          ...
          <p className="mt-6 max-w-md text-base leading-relaxed text-mute">
            ...
            corte, si corresponde, se escribe.
          </p>
        </Reveal>
