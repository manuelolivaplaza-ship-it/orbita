    ...
    return (
      <section className="seccion pagina">
        <header className="pagina-cab">
          ...
          <Btn a={rutas.catalogo}>Volver a tratamientos</Btn>
        </header>
      </section>
    );
  }
    ...
    <>
      <section className="ficha-cab pagina">
        <nav className="migas" aria-label="Migas de pan">
          ...
          <span>/</span>
          <Enlace a={rutas.catalogo}>Tratamientos</Enlace>
          <span>/</span>
          <em>{p.ref}</em>
        </nav>
      ...
      <section className="pagina ficha-cuerpo">
        ...
        <aside className="ficha-col-b">
          <Revelar className="ficha-cta">
            <p className="kicker">Consultar por este tratamiento</p>
            <h2>¿Lo agendamos?</h2>
            ...
            <Formulario
              ...
              asunto={`Consulta tratamiento ${p.ref}`}
            />
      ...
      {similares.length > 0 && (
        <section className="seccion">
          <div className="seccion-cab">
            <Revelar>
              <p className="kicker">Tratamientos relacionados</p>
