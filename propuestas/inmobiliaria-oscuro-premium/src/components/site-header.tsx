    ...
    >
      <div className="shell flex h-[4.5rem] items-center justify-between gap-4">
        ...
        <div className="hidden items-center gap-5 lg:flex">
          ...
          <Link href="/consulta" className="btn btn-primary !min-h-10 !px-5">
      ...
      {open ? (
        <div className="fixed inset-0 top-[4.5rem] z-40 bg-void lg:hidden">
          <nav className="shell flex flex-col pt-8" aria-label="Móvil">
            ...
            <Link href="/consulta" className="btn btn-primary mt-8 w-full">
              Solicitar presentación
            </Link>
            <p className="mt-6 text-center font-mono text-[0.72rem] tracking-wide text-muted">
              {site.coords}
            </p>
          </nav>
        </div>
