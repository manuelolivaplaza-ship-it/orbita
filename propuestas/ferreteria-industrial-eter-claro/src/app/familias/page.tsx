...
export const metadata: Metadata = {
  title: "Familias",
  description:
    "Seis familias de patio: fierro, pernos, maderas, cemento, planchas y herramientas. Precio con IVA y stock rotulado.",
};
      ...
      <header className="mx-auto max-w-[1480px] px-5 py-16 md:px-10 md:py-24 lg:px-16">
        <Reveal>
          ...
          <h1 className="mt-5 max-w-3xl font-display text-[clamp(2.8rem,6vw,6.4rem)] font-light leading-[0.9] tracking-tight">
            Seis calles.
            <br />
            <em className="italic">Un patio.</em>
          </h1>
          <p className="mt-6 max-w-md text-base leading-relaxed text-ink-soft">
            Cada familia es una calle del recinto. El precio se lee. El stock
            se nombra. El corte, si corresponde, se escribe.
          </p>
        </Reveal>
      </header>
          ...
          >
            ...
            >
              <div>
                ...
                <p className="mt-6 font-mono text-[0.62rem] uppercase tracking-[0.18em] text-steel">
                  desde {formatCLP(family.fromIva)} · {family.measure}
                </p>
              </div>
