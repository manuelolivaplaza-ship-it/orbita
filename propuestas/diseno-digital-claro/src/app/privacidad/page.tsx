    ...
    <>
      ...
      <section className="pb-24 md:pb-32">
        <div className="wrap max-w-3xl space-y-8 text-[16px] leading-relaxed text-muted">
          <p>
            Responsable: {site.legal}, RUT {site.rut}, {site.address.street},{" "}
            {site.address.commune}. Correo: {site.email}.
          </p>
          <p>
            Recogemos nombre, correo, teléfono, organización y el mensaje que
            nos escribes por el formulario, WhatsApp o correo. La base legal es
            tu solicitud de contacto y, si hay contrato, la ejecución de ese
            contrato. Nos rige la Ley 19.628 sobre protección de la vida
            privada.
          </p>
          <p>
