...
export const metadata: Metadata = {
  title: "Contacto",
  description:
    "Escribe a Nítida. Estudio de diseño digital en Avenida Italia, Ñuñoa. Correo, WhatsApp o una visita con hora.",
};
    ...
    <>
      <section className="wrap pb-10 pt-12 md:pb-14 md:pt-20">
        ...
        <p className="mt-8 max-w-xl text-[1.12rem] leading-[1.7] text-muted">
          Cuéntanos qué hay hoy y qué duele. No hace falta un brief perfecto. Si
          el encargo está claro —o si todavía no— lo miramos juntos.
        </p>
      </section>
      ...
      <section className="wrap grid gap-14 pb-24 md:grid-cols-12 md:pb-32">
        ...
        <aside className="md:col-span-4 md:col-start-9">
          <div className="img-frame relative mb-10 aspect-[4/5]">
            <Image
              src="/images/italia.jpg"
              alt="Avenida Italia, Ñuñoa, a primera hora."
              fill
          ...
          <address className="mt-4 space-y-2 text-[1.02rem] not-italic leading-relaxed">
            ...
            <p className="text-sm text-muted">{site.metro}</p>
            <p className="pt-4">
          ...
          <LuzNorte className="mt-3 block eyebrow" />
          <p className="mt-8 text-sm text-muted">
            <a className="link-line" href={site.address.maps}>
              Ver en el mapa
            </a>
          </p>
        </aside>
