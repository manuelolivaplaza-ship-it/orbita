      ...
      <div className="wrap py-16 md:py-24">
        <div className="flex flex-col gap-12 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <Link
              href="/contacto"
              className="mt-4 block font-display text-[clamp(3.2rem,8vw,7rem)] leading-[0.9] tracking-[-0.04em] text-ink transition-colors hover:text-norte"
            >
              Conversemos
            </Link>
          </div>
          <p className="max-w-xs text-[0.95rem] leading-relaxed text-muted">
            Un correo basta. Si el encargo está claro —o si todavía no— lo
            miramos juntos, a luz de día.
          </p>
        </div>
        ...
        <div className="grid gap-10 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <p className="mt-4 max-w-sm text-sm leading-relaxed text-muted">
              Estudio de diseño digital en Ñuñoa. Identidad, producto y sitios
              con la claridad de la luz norte.
            </p>
          </div>
          <div>
        ...
        <div className="mt-16 flex flex-col gap-3 text-xs tracking-[0.04em] text-muted md:flex-row md:items-center md:justify-between">
          <p>
            © {new Date().getFullYear()} {site.legal}. Hecho en Santiago.
          </p>
