...
export const metadata: Metadata = {
  title: "Escribir",
  description:
    "Pida un sondaje en CAUCE. Av. Santa María 2120, Providencia. WhatsApp, correo o el formulario. Respuesta en 24 horas hábiles.",
};
        ...
        <div className="shell grid gap-16 lg:grid-cols-12">
          <Reveal className="lg:col-span-5">
            ...
            <p className="mt-6 max-w-md text-[17px] leading-relaxed text-muted">
              ...
              y un honorario. Si no, se lo decimos — y a quién conviene
              llamar.
            </p>
            ...
            <div className="mt-10 space-y-8">
              <Nivel />
              <div>
                <p className="kicker mb-2">Orilla</p>
              ...
              <div>
                ...
                <p className="text-[16px] leading-relaxed text-muted">{site.hours}</p>
              </div>
              <a
                href={site.whatsapp}
      ...
      <section className="pb-0">
        <div className="relative h-[50vh] min-h-[360px] lg:h-[62vh]">
          <Image
            ...
            alt="Fachada de CAUCE en Av. Santa María 2120, Providencia"
            fill
            sizes="100vw"
            className="object-cover"
          />
          <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-navy/60 to-transparent p-6 lg:p-10">
            <p className="text-[12px] tracking-[0.2em] text-paper uppercase">
