    ...
    return (
      <section className="seccion pagina">
        <header className="pagina-cab">
          ...
          <Btn a={rutas.catalogo}>Volver a clases</Btn>
        </header>
      </section>
    );
  }
    ...
    <>
      <section className="ficha-cab pagina">
        <nav className="migas" aria-label="Migas de pan">
          ...
          <span>/</span>
          <Enlace a={rutas.catalogo}>Clases</Enlace>
          <span>/</span>
          <em>{p.ref}</em>
        </nav>
      ...
      <section className="pagina ficha-cuerpo">
        ...
        <aside className="ficha-col-b">
          <Revelar className="ficha-cta">
            <p className="kicker">Consultar por esta clase</p>
            <h2>¿Lo agendamos?</h2>
      ...
      {similares.length > 0 && (
        <section className="seccion">
          <div className="seccion-cab">
            <Revelar>
              <p className="kicker">Clases relacionadas</p>
              <h2>Otras clases</h2>
            </Revelar>
          </div>
