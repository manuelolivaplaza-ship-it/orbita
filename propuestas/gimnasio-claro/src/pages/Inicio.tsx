    ...
    <>
      ...
      <section className="seccion" id="destacadas">
        <div className="seccion-cab">
          <Revelar>
            <p className="kicker">Clases y planes</p>
            <h2>
              Clases que <em>cambian</em> la semana.
            </h2>
          </Revelar>
          <Revelar delay={120}>
            <Enlace a={rutas.catalogo} className="enlace-flecha">
              Ver las {propiedades.length} clases →
            </Enlace>
          </Revelar>
        </div>
      ...
      <section className="seccion" id="servicios">
        <div className="seccion-cab">
          <Revelar>
            ...
            <h2>Cuatro formas de moverte, un mismo estándar.</h2>
          </Revelar>
        </div>
      ...
      <section className="seccion" id="testimonios">
        <div className="seccion-cab">
          <Revelar>
            <p className="kicker">Cartas de alumnos</p>
      ...
      <section className="cinta-cta">
        <Revelar>
          <h2>
            ¿Empezamos esta <em>semana</em>?
          </h2>
          <p>Clase de prueba gratis con plan de entrenamiento escrito.</p>
          <div className="hero-ctas">
            <Btn a={rutas.captacion}>Empezar ahora</Btn>
