        ...
        <div className="grid gap-12 lg:grid-cols-12">
          <div className="lg:col-span-5">
            ...
            <p className="mt-6 max-w-sm text-[16px] leading-relaxed text-muted">
              Corredora de departamentos y casas con orientación norte.
              Providencia, Ñuñoa y Las Condes. Desde {site.founded}.
            </p>
            <p className="font-mono mt-8 text-[12px] tracking-wide text-norte">
