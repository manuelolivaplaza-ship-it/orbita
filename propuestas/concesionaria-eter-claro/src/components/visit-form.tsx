...
export function VisitForm({
  ...
  if (sent) {
    return (
      <div className="border border-line bg-paper-2/60 px-8 py-16">
        ...
        <a href={site.whatsappHref} className="btn btn-gold mt-10">
          Abrir WhatsApp
        </a>
      </div>
    );
    ...
    <form onSubmit={onSubmit} className="grid gap-8">
      ...
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <label className="block">
          ...
          <select name="momento" className="input-line mt-2" defaultValue="manana">
            <option value="manana">Mañana · 11:00 a 13:00</option>
            <option value="tarde">Tarde · 15:00 a 19:00</option>
