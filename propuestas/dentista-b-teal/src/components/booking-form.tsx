  ...
  if (status === "ok") {
    return (
      <div className="rounded-[1.6rem] border border-border bg-card p-8 sm:p-10">
        <p className="text-[0.7rem] tracking-[0.2em] uppercase text-lagoon">
          Recibido
        </p>
    ...
    >
      <div className="grid gap-5 sm:grid-cols-2">
        ...
        <div className="grid gap-2 sm:col-span-2">
          ...
          <Textarea
            ...
            name="notes"
            rows={4}
            placeholder="Si hay miedo, dolor, o llevas tiempo sin ir, dínoslo aquí. Adaptamos la hora."
      ...
      {status === "error" ? (
        <p className="mt-4 text-sm text-destructive">
          No hemos podido enviar. Prueba de nuevo o llama al {site.phone}.
        </p>
      ) : null}
      <Button
        type="submit"
