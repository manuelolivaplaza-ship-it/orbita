...
export function SiteHeader() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex h-[4.4rem] max-w-[1180px] items-center justify-between gap-4 px-5 sm:px-8">
        ...
        <nav className="hidden items-center gap-7 lg:flex">
          {nav.map((item) => (
            <Link
              ...
              href={item.href}
              className={cn(
                "text-[0.78rem] tracking-[0.06em] transition-colors",
                overHero
        ...
        <div className="hidden items-center gap-3 lg:flex">
          ...
          >
            <Phone
              className={cn(
                "size-3.5",
                overHero ? "text-lagoon" : "text-lagoon"
              )}
            />
            {site.phone}
          </a>
          <Button
            asChild
            className={cn(
              "h-10 rounded-full px-5 text-[0.82rem] tracking-wide",
              overHero &&
                "border-primary-foreground/25 bg-primary-foreground text-tide hover:bg-primary-foreground/90"
            )}
          >
        ...
        <Sheet open={open} onOpenChange={setOpen}>
          <SheetTrigger asChild>
            <Button
              ...
              className={cn(
                "lg:hidden",
                overHero && "text-primary-foreground hover:bg-primary-foreground/10"
              )}
