    ...
    return (
      <section className="seccion pagina">
        <header className="pagina-cab">
          ...
          <Btn a={rutas.catalogo}>Volver a áreas</Btn>
        </header>
      </section>
    );
  }
    ...
    <>
      <section className="ficha-cab pagina">
        <nav className="migas" aria-label="Migas de pan">
          ...
          <span>/</span>
          <Enlace a={rutas.catalogo}>Áreas</Enlace>
          <span>/</span>
          <em>{p.ref}</em>
        </nav>
      ...
      <section className="pagina ficha-cuerpo">
        <div className="ficha-col-a">
          ...
          <Revelar>
            <div className="prosa">
              ...
              <p>{p.descripcion}</p>
              <p>
                El alcance del asunto, el honorario y los plazos se confirman en la primera
                consulta, con todo por escrito antes de partir.
              </p>
            </div>
          </Revelar>
          {p.dormitorios > 0 && (
        ...
        <aside className="ficha-col-b">
          <Revelar className="ficha-cta">
            <p className="kicker">Consultar por esta área</p>
            <h2>¿Su caso es de esta área?</h2>
            <p className="ficha-cta-sub">
              Le explicamos cómo trabajamos esta área, los plazos reales y el honorario estimado
              para su caso.
            </p>
            <Formulario
              campos={[
                ...
                { nombre: "correo", etiqueta: "Correo", tipo: "email" },
                {
                  ...
                  tipo: "select",
                  opciones: ["Consulta puntual", "Juicio en curso", "Preventivo para mi empresa", "Aún no sé"],
                },
              ]}
              asunto={`Consulta área ${p.ref}`}
            />
      ...
      {similares.length > 0 && (
        <section className="seccion">
          <div className="seccion-cab">
            <Revelar>
              <p className="kicker">Áreas relacionadas</p>
              <h2>Otras áreas del estudio</h2>
            </Revelar>
          </div>
