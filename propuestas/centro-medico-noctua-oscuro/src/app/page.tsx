...
function Hero() {
  return (
    <section className="relative h-[100svh] min-h-[640px] overflow-hidden bg-void">
      <Image
        src="/images/hero.jpg"
        alt="Consulta NOCTUA de noche: camilla de lino oscuro, lámpara ámbar y Santiago al otro lado del vidrio"
        fill
        priority
        sizes="100vw"
      ...
      <div className="relative flex h-full max-w-[1440px] flex-col justify-end px-6 pb-12 pt-28 md:px-10 md:pb-16 lg:px-16">
        ...
        >
          Centro médico · Vitacura · último cupo {site.lastSlot}
        </p>
        <h1
        ...
        >
          De día el síntoma se disfraza. De noche, si alguien sabe mirar, se
          nombra. Ocho especialidades. Laboratorio e imagen en esta casa.
        </p>
        <div
        ...
        >
          ...
          <Link href="/urgencia" className="btn btn-light">
            ¿Es urgencia?
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="border-b border-line bg-void">
      <div className="shell flex flex-wrap items-center gap-x-10 gap-y-3 py-5">
        ...
        <Pulse className="ml-auto hidden h-8 w-48 text-amber/80 lg:block" />
      </div>
    </div>
  );
}
      ...
      <div className="shell grid items-start gap-12 md:grid-cols-12">
        <Reveal className="md:col-span-6">
          ...
          <h2 className="mt-6 max-w-xl font-display text-5xl font-semibold leading-[1.02] tracking-tight md:text-6xl">
            El diagnóstico también tiene una noche.
          </h2>
        </Reveal>
        <Reveal className="md:col-span-5 md:col-start-8 md:pt-16" delay={120}>
          <p className="text-lg leading-relaxed text-paper-dim">
            ...
            internista, un laboratorio en otro edificio, un informe que llega
            cuando ya olvidaste por qué lo pediste. Aquí no.
          </p>
          <p className="mt-5 text-lg leading-relaxed text-paper-dim">
            ...
            casa de piedra en Nueva Costanera. Ocho médicos. El mismo de
            principio a fin.
          </p>
          <Link
            href="/casa"
      ...
      <div className="shell">
        <Reveal className="max-w-2xl">
          ...
          <h2 className="mt-5 font-display text-[clamp(2.4rem,4.6vw,4.6rem)] font-semibold leading-[0.98] tracking-tight">
            Cada especialidad es una estrella.
          </h2>
    ...
    <section className="border-t border-line py-28 md:py-36">
      <div className="shell">
        <Reveal className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
          <div>
            <p className="kicker">Ocho salas</p>
        ...
        <div className="flex flex-col justify-center px-6 py-16 md:col-span-5 md:px-12 lg:px-16">
          <Reveal>
            ...
            <p className="mt-6 text-base leading-relaxed text-paper-dim">
              Lun a vie, 16:00 a 23:00. Sábado, 09:00 a 14:00. El cupo de las
    ...
    <section className="py-28 md:py-36">
      <div className="shell">
        <Reveal>
          ...
          <h2 className="mt-4 max-w-2xl font-display text-[clamp(2.2rem,4.4vw,4.2rem)] font-semibold tracking-tight">
            El mismo médico de principio a fin.
          </h2>
        </Reveal>
        ...
        <div className="flex flex-col justify-center px-6 py-16 md:col-span-5 md:px-12 lg:px-16">
          <Reveal>
            ...
            <p className="mt-6 text-base leading-relaxed text-paper-dim">
              ...
              avenida. Es una casa: ocho salas, un laboratorio, imagen, una
              habitación de sueño. El jardín al otro lado del vidrio.
            </p>
      ...
      <div className="shell grid gap-12 py-24 lg:grid-cols-12 lg:py-32">
        <Reveal className="lg:col-span-7">
          ...
          <h2 className="mt-4 font-display text-[clamp(2.4rem,5vw,5rem)] font-semibold leading-[0.95] tracking-tight">
            Pide la noche. Nosotros el resto.
          </h2>
          <a
            href={site.phoneHref}
          ...
          <p className="mt-6 max-w-md text-sm leading-relaxed text-paper-dim">
            Responden de la casa, no un call center. Si no contestamos,
            devolvemos el llamado el mismo día.
          </p>
