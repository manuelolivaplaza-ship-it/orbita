  ...
  return (
    <>
      ...
      <section className="seccion" id="destacadas">
        <div className="seccion-cab">
          <Revelar>
            ...
            <h2>
              Tres obras que <em>hablan</em> solas.
            </h2>
          </Revelar>
          <Revelar delay={120}>
            <Enlace a={rutas.catalogo} className="enlace-flecha">
              Ver los {propiedades.length} proyectos →
            </Enlace>
          </Revelar>
        </div>
      ...
      <section className="cita-parallax">
        <Revelar>
          <blockquote>
            “Nos mostraron el presupuesto por partida antes del anteproyecto. Sabíamos cuánto
            costaba la casa antes de enamorarnos de ella.”
            <footer>— Familia Echeverría · mandantes, Casa Los Vilos</footer>
          </blockquote>
        </Revelar>
      </section>
      ...
      <section className="seccion" id="testimonios">
        <div className="seccion-cab">
          <Revelar>
            <p className="kicker">Cartas de mandantes</p>
            <h2>Lo que dicen quienes construyeron con nosotros.</h2>
          </Revelar>
        </div>
      ...
      <section className="cinta-cta">
        <Revelar>
          <h2>
            ¿Conversamos sobre su <em>proyecto</em>?
          </h2>
          <p>Visita de medición sin costo y una primera orientación el mismo día hábil.</p>
          <div className="hero-ctas">
            <Btn a={rutas.captacion}>Consultar por un proyecto</Btn>
