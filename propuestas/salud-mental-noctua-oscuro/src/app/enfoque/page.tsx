...
export const metadata: Metadata = {
  title: "Enfoque",
  description:
    "Cómo se trabaja en NOCTUA: emparejamiento, cincuenta minutos, la misma persona, secreto profesional. Las Condes, de 16:00 a 23:00.",
};
...
const principles = [
  ...
  },
  {
    ...
    text: "Cuando el fármaco cabe, no te mandamos a otra comuna. Catalina Errázuriz coordina con quien te ve en palabra. Una ficha. Una versión.",
  },
  {
    title: "Decir que no",
  ...
  return (
    <>
      <PageIntro
        ...
        lead="NOCTUA no es una app, ni un call center de horas, ni un pack de veinte sesiones. Es una casa en Las Condes y un criterio clínico que abre a las 16:00."
      />
        ...
        <div className="shell grid gap-8 lg:grid-cols-12">
          <div className="frame relative aspect-[16/10] lg:col-span-7 lg:aspect-auto lg:min-h-[520px]">
            <Image
              ...
              alt="Dos sillones de lino frente a frente en una sala nocturna"
              fill
              priority
      ...
      <section className="border-t border-line py-24 lg:py-32">
        <div className="shell grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {principles.map((item, index) => (
            <Reveal key={item.title} delay={index * 60} className="border-t border-line pt-8">
              <h2 className="font-display text-3xl font-semibold tracking-tight">
                {item.title}
              </h2>
              <p className="mt-4 text-[16px] leading-relaxed text-paper-dim">
                {item.text}
              </p>
            </Reveal>
          ))}
