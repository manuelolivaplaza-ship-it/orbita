...
export const metadata: Metadata = {
  title: "Primera hora",
  description:
    "Pide tu primera hora en NOCTUA. Emparejamos con una persona del equipo. Las Condes, de 16:00 a 23:00, y online.",
};
          ...
          <aside className="lg:col-span-4 lg:col-start-9">
            ...
            <div className="mt-12 border-t border-line pt-8">
              ...
              <p className="mt-3 text-sm leading-relaxed text-paper-dim">
                ...
                <a href={site.crisis.phoneHref} className="link-line nums">
                  Salud Responde {site.crisis.phone}
                </a>
                . Prevención del suicidio:{" "}
                <a href={site.crisis.altHref} className="link-line">
                  {site.crisis.alt}
                </a>
                .
              </p>
