        ...
        <div className="shell max-w-3xl space-y-10 text-[16px] leading-relaxed text-paper-dim">
          ...
          <div>
            ...
            <p className="mt-3">
              ...
              historia, plan, coordinaciones. No vendemos listas. No hacemos
          ...
          <div>
            ...
            <p className="mt-3">
              No se informa a empleadores, parejas ni colegios sin su
              consentimiento, salvo las excepciones legales: riesgo vital u
              orden judicial. Te lo explicamos por escrito en la primera hora.
            </p>
          </div>
        </div>
      </section>
