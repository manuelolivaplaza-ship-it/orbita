...
export const metadata: Metadata = {
  title: "Valores",
  description:
    "Honorarios NOCTUA: primera hora, sesiones, pareja y psiquiatría. Boleta reembolsable. Las Condes.",
};
...
const notes = [
  ...
  {
    title: "Cancelación",
    text: "24 horas de anticipación. Menos que eso, se cobra: el cupo es de una persona. WhatsApp o +56 2 3288 4770.",
  },
];
    ...
    <>
          ...
          {prices.map((price, index) => (
            ...
            >
              <div>
                ...
                <p className="mt-1 font-mono text-[0.58rem] uppercase tracking-[0.18em] text-muted">
                  {price.detail}
                </p>
              </div>
              <p className="shrink-0 font-display text-2xl font-semibold nums md:text-3xl">
      ...
      <section className="border-t border-line py-24">
        <div className="shell grid gap-10 md:grid-cols-2">
          {notes.map((note) => (
            <Reveal key={note.title} className="border-t border-line pt-8">
