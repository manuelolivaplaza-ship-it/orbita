      ...
      <div className="shell grid gap-16 py-20 md:grid-cols-12">
        <div className="md:col-span-5">
          ...
          <p className="mt-6 max-w-sm text-sm leading-relaxed text-muted">
            Centro de salud mental. Las Condes, Santiago. Abrimos cuando la
            ciudad baja la voz.
          </p>
          <p className="mt-8 max-w-sm text-sm leading-relaxed text-paper-dim">
            {site.crisis.label}.{" "}
        ...
        <div className="md:col-span-3">
          ...
          <ul className="mt-5 space-y-3 text-sm text-paper-dim">
            ...
            <li>
              <Link href="/casa" className="link-line">
                La casa
              </Link>
            </li>
            <li>
