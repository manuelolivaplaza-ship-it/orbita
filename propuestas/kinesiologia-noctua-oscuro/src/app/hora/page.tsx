...
export const metadata: Metadata = {
  title: "Pedir hora",
  description:
    "Agenda una lectura kinésica en NOCTUA. 75 minutos, Vitacura, último cupo 21:30. Respuesta el mismo día hábil.",
};
      ...
      <div className="md:col-span-5">
        <Reveal>
          ...
          <h1 className="mt-5 font-display text-6xl font-semibold tracking-tight md:text-7xl">
            Setenta y cinco minutos. Un mapa.
          </h1>
          <p className="mt-6 max-w-md text-lg leading-relaxed text-paper-dim">
            ...
            cuerpo ya dejó de representar. Si el cupo del día está lleno, se lo
            decimos.
          </p>
        </Reveal>
        ...
        <div className="relative mt-12 aspect-[4/5] overflow-hidden md:mt-16">
          <Image
            ...
            alt="Box NOCTUA de noche, con la ciudad al otro lado del vidrio"
            fill
