...
export const SECTORES: Sector[] = [
  ...
  },
  {
    slug: 'salud-mental',
    label: 'Salud mental',
    heroTitle: 'Sitios web para centros de salud mental',
    description: 'Primera sesión, modalidad y aranceles, con un tono que no apura ni dramatiza.',
    accent: '#6D28D9',
    icon: Brain,
  },
  {
    slug: 'kinesiologia',
    label: 'Kinesiología',
    heroTitle: 'Sitios web para centros de kinesiología',
    description: 'Recuperación, agenda y especialidades: el sitio como extensión del box.',
    accent: '#0F766E',
    icon: Activity,
  },
  {
    slug: 'laboratorio',
    label: 'Laboratorio',
    heroTitle: 'Sitios web para laboratorios clínicos',
    description: 'Exámenes, toma de muestras y resultados: precisión visual al servicio de la confianza.',
    accent: '#1D4ED8',
    icon: FlaskConical,
  },
  {
