...
export const PropuestaCard: React.FC<{
  ...
  return (
    <article
      className={`galeria-card group relative flex flex-col ${wide ? 'md:col-span-2' : ''}`}
    ...
    >
      ...
      <div className="pointer-events-none">
        ...
        >
          ...
          <span className="absolute left-3 top-3 rounded-full bg-white/90 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-zinc-600 shadow-sm">
            Demo
          </span>
        </div>
