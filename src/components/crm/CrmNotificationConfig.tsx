  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex items-start justify-between gap-3">
            <div className="flex min-w-0 items-start gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-0.5 text-[11px] leading-snug text-zinc-500">Recibe una alerta instantánea cada vez que alguien solicita una hora o cotización.</p>
              </div>
            </div>
          ...
          <div className="flex items-start justify-between gap-3">
            <div className="flex min-w-0 items-start gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-0.5 text-[11px] leading-snug text-zinc-500">Envía el payload JSON de cada lead a tu software de gestión o CRM externo.</p>
              </div>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
        ...
        <div className="flex items-start justify-between gap-3 rounded-xl border border-zinc-200/80 bg-white p-5 shadow-xs">
          <div className="flex min-w-0 items-start gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-0.5 text-[11px] leading-snug text-zinc-500">Reproduce un timbre sutil en la pantalla de recepción cuando llega un prospecto.</p>
            </div>
          </div>
          <label className="relative inline-flex items-center cursor-pointer">
            <input
        ...
        <div className="flex flex-col-reverse items-stretch gap-3 pt-2 sm:flex-row sm:items-center sm:justify-end">
          {savedSuccess && (
            <span className="flex items-center justify-center gap-1.5 text-xs font-medium text-emerald-600 animate-fade-in sm:justify-start">
          ...
          <button
            type="submit"
            className="inline-flex min-h-11 items-center justify-center gap-2 rounded-lg bg-zinc-900 px-5 py-2.5 text-xs font-semibold text-white shadow-xs transition-colors hover:bg-zinc-800 sm:min-h-0 sm:py-2"
          >
