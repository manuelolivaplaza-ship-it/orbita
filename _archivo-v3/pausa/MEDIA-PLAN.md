# MEDIA-PLAN — pausa · Pausa · dental
> Generado con muse-spark-1.2-contributor (opencode-go) — prompts listos para Google Flow / FAL flux pro
> Fecha: 2026-08-28 · Workspace: propuestas/pausa

## Identidad
- Marca: Pausa — Consulta dental de adultos, agenda limitada
- Sector: dental — Consulta dental de adultos con agenda limitada: calma, exclusividad y diseño claro.
...
4. `npm --prefix propuestas/pausa run build` (tsc --noEmit && vite build) hasta verde.
