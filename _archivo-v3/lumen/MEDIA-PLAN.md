# MEDIA-PLAN — lumen · Lumen · dental
> Generado con muse-spark-1.2-contributor (opencode-go) — prompts listos para Google Flow / FAL flux pro
> Fecha: 2026-08-28 · Workspace: propuestas/lumen

## Identidad
- Marca: Lumen — Diagnóstico dental con escáner en la primera visita
- Sector: dental — Diagnóstico dental con escáner en la primera visita: tecnología y confianza en azul.
...
- Media actual en public/media/: facade.jpg, object.jpg, room.jpg (3 archivo(s) jpg/png)
...
4. `npm --prefix propuestas/lumen run build` (tsc --noEmit && vite build) hasta verde.
