# MEDIA-PLAN — software-claro · Cordillera Software · software
> Generado con muse-spark-1.2-contributor (opencode-go) — prompts listos para Google Flow / FAL flux pro
> Fecha: 2026-08-28 · Workspace: propuestas/software-claro

## Identidad
- Marca: Cordillera Software — Cordillera Software — Propuesta de rediseño · Órbita
- Sector: software — Casa de software clara y ordenada: servicios, stack y casos para clientes B2B.
...
- Media actual en public/media/: bloques.png, capas.png, pasillo.png (3 archivo(s) jpg/png)
...
4. `npm --prefix propuestas/software-claro run build` (tsc --noEmit && vite build) hasta verde.
