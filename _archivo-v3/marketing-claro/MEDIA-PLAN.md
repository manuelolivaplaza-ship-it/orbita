# MEDIA-PLAN — marketing-claro · Estudio Norte · marketing
> Generado con muse-spark-1.2-contributor (opencode-go) — prompts listos para Google Flow / FAL flux pro
> Fecha: 2026-08-28 · Workspace: propuestas/marketing-claro

## Identidad
- Marca: Estudio Norte — Estudio Norte — Marketing con criterio, no ruido
- Sector: marketing — Agencia de marketing con criterio: servicios, casos y una propuesta clara, sin ruido.
...
- Media actual en public/media/: corredor.png, formas.png, mesa.png, papel.png (4 archivo(s) jpg/png)
...
4. `npm --prefix propuestas/marketing-claro run build` (tsc --noEmit && vite build) hasta verde.
