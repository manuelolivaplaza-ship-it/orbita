# MEDIA-PLAN — inmobiliaria-oscuro-premium · ALTAMAR Propiedades · inmobiliaria
> Generado con muse-spark-1.2-contributor (opencode-go) — prompts listos para Google Flow / FAL flux pro
> Fecha: 2026-08-28 · Workspace: propuestas/inmobiliaria-oscuro-premium

## Identidad
- Marca: ALTAMAR Propiedades — ALTAMAR Propiedades · Propuesta Órbita
- Sector: inmobiliaria — Inmobiliaria premium con dirección oscura: sobriedad, catálogo y experiencia de alto nivel.
...
- Media actual en public/media/: casa.png, cocina.png, living.png, terraza.png (4 archivo(s) jpg/png)
...
4. `npm --prefix propuestas/inmobiliaria-oscuro-premium run build` (tsc --noEmit && vite build) hasta verde.
