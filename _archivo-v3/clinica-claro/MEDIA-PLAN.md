# MEDIA-PLAN — clinica-claro · Clínica Lircay · dental
> Generado con muse-spark-1.2-contributor (opencode-go) — prompts listos para Google Flow / FAL flux pro
> Fecha: 2026-08-28 · Workspace: propuestas/clinica-claro

## Identidad
- Marca: Clínica Lircay — Propuesta de rediseño — Clínica Lircay
- Sector: dental — Clínica con diseño claro y minimalista: especialidades, equipo y agenda destacada.
...
- Media actual en public/media/: hall.png, laboratorio.png, pasillo.png (3 archivo(s) jpg/png)
...
4. `npm --prefix propuestas/clinica-claro run build` (tsc --noEmit && vite build) hasta verde.
