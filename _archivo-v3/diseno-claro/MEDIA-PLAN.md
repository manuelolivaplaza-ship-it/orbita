# MEDIA-PLAN — diseno-claro · Estudio Trazo · diseno
> Generado con muse-spark-1.2-contributor (opencode-go) — prompts listos para Google Flow / FAL flux pro
> Fecha: 2026-08-28 · Workspace: propuestas/diseno-claro

## Identidad
- Marca: Estudio Trazo — Propuesta de rediseño · diseño claro
- Sector: diseno — Estudio de diseño digital: el sitio como pieza de portafolio, con grilla y detalle tipográfico.
...
- Media actual en public/media/: biblioteca-estudio.png, mesa-trabajo.png, papel-macro.png, posters-prensa.png (4 archivo(s) jpg/png)
...
4. `npm --prefix propuestas/diseno-claro run build` (tsc --noEmit && vite build) hasta verde.
