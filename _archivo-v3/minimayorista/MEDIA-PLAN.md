# MEDIA-PLAN — minimayorista · minimayorista · general
> Generado con muse-spark-1.2-contributor (opencode-go) — prompts listos para Google Flow / FAL flux pro
> Fecha: 2026-08-28 · Workspace: propuestas/minimayorista

## Identidad
- Marca: minimayorista — Sitio web y tienda online
- Sector: general — 
...
4. `npm --prefix propuestas/minimayorista run build` (tsc --noEmit && vite build) hasta verde.
