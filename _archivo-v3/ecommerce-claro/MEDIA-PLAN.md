# MEDIA-PLAN — ecommerce-claro · Bazar Austral · ecommerce
> Generado con muse-spark-1.2-contributor (opencode-go) — prompts listos para Google Flow / FAL flux pro
> Fecha: 2026-08-28 · Workspace: propuestas/ecommerce-claro

## Identidad
- Marca: Bazar Austral — Propuesta de rediseño · ecommerce claro
- Sector: ecommerce — Tienda online clara y rápida: vitrina, catálogo y checkout pensados para convertir.
...
- Media actual en public/media/: lino-detalle.png, producto-textil.png, tienda-interior.png (3 archivo(s) jpg/png)
...
4. `npm --prefix propuestas/ecommerce-claro run build` (tsc --noEmit && vite build) hasta verde.
