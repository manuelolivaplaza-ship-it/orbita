# MEDIA-PLAN — alba · Alba · dental
> Generado con muse-spark-1.2-contributor (opencode-go) — prompts listos para Google Flow / FAL flux pro
> Fecha: 2026-08-28 · Workspace: propuestas/alba

## Identidad
- Marca: Alba — Urgencia dental con hora el mismo día
- Sector: dental — Urgencia dental con hora el mismo día: sitio directo, con reserva rápida y tono cálido.
...
- Media actual en public/media/: corridor.jpg, desk.jpg, facade.jpg, object.jpg (4 archivo(s) jpg/png)
...
4. `npm --prefix propuestas/alba run build` (tsc --noEmit && vite build) hasta verde.
