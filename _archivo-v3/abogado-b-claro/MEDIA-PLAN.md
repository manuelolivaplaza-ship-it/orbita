# MEDIA-PLAN — abogado-b-claro · Bravo & Soto Abogados · legal
> Generado con muse-spark-1.2-contributor (opencode-go) — prompts listos para Google Flow / FAL flux pro
> Fecha: 2026-08-28 · Workspace: propuestas/abogado-b-claro

## Identidad
- Marca: Bravo & Soto Abogados — Bravo & Soto Abogados — Propuesta de rediseño · Órbita
- Sector: legal — Estudio jurídico de proximidad: diseño claro y minimalista, sereno y cercano.
...
4. `npm --prefix propuestas/abogado-b-claro run build` (tsc --noEmit && vite build) hasta verde.
