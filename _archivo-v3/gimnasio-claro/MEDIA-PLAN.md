# MEDIA-PLAN — gimnasio-claro · Estudio Savia · bienestar
> Generado con muse-spark-1.2-contributor (opencode-go) — prompts listos para Google Flow / FAL flux pro
> Fecha: 2026-08-28 · Workspace: propuestas/gimnasio-claro

## Identidad
- Marca: Estudio Savia — Estudio Savia — Propuesta de rediseño · Órbita
- Sector: bienestar — Pilates, yoga y barre: diseño claro y orgánico, con clases, planes y horarios.
...
- Media actual en public/media/: barra.png, estudio.png, props.png, yoga.png (4 archivo(s) jpg/png)
...
4. `npm --prefix propuestas/gimnasio-claro run build` (tsc --noEmit && vite build) hasta verde.
