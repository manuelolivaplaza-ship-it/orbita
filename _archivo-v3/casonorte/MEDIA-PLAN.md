# MEDIA-PLAN — casonorte · Casa Norte · dental
> Generado con muse-spark-1.2-contributor (opencode-go) — prompts listos para Google Flow / FAL flux pro
> Fecha: 2026-08-28 · Workspace: propuestas/casonorte

## Identidad
- Marca: Casa Norte — Clínica dental integral en Santiago
- Sector: dental — Clínica dental integral en Santiago: tratamientos, equipo y horas en un recorrido sereno.
...
- Media actual en public/media/: desk.jpg, facade.jpg, object.jpg, room.jpg (4 archivo(s) jpg/png)
...
4. `npm --prefix propuestas/casonorte run build` (tsc --noEmit && vite build) hasta verde.
