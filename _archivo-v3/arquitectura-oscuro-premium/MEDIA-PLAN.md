# MEDIA-PLAN — arquitectura-oscuro-premium · UMBRAL · arquitectura
> Generado con muse-spark-1.2-contributor (opencode-go) — prompts listos para Google Flow / FAL flux pro
> Fecha: 2026-08-28 · Workspace: propuestas/arquitectura-oscuro-premium

## Identidad
- Marca: UMBRAL — UMBRAL — Propuesta de rediseño · Órbita
- Sector: arquitectura — Obra de alto estándar con materiales que envejecen bien: dirección oscura premium y un socio acompañando cada proyecto.
...
- Media actual en public/media/: escalera.png, hormigon.png, maqueta.png, pavilon-noche.png (4 archivo(s) jpg/png)
...
4. `npm --prefix propuestas/arquitectura-oscuro-premium run build` (tsc --noEmit && vite build) hasta verde.
