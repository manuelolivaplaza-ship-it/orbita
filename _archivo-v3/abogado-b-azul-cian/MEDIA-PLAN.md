# MEDIA-PLAN — abogado-b-azul-cian · Arrieta & Cía. Abogados · legal
> Generado con muse-spark-1.2-contributor (opencode-go) — prompts listos para Google Flow / FAL flux pro
> Fecha: 2026-08-28 · Workspace: propuestas/abogado-b-azul-cian

## Identidad
- Marca: Arrieta & Cía. Abogados — Arrieta & Cía. Abogados
- Sector: legal — Estudio jurídico con acentos azul cián: técnico, moderno y con navegación por prácticas.
...
```
photorealistic instrumental esterilizado, empty law office, Chilean contemporary, VACÍA, sin personas, paper bone #F9FBFC, ink #14212B, cold gray #6E7E88, cyan #0B76A8 / #35A7CE accent <5%, north daylight through large window, soft morning light 10am, gentle shadows, serene, editorial interior photography, Scandinavian minimal, medium format, f/8, calm and silent, Chile contemporary, no text, no logo, no watermark, no people, no hands, no faces, --ar 16:9
```
Negative: PROHIBIDO: personas/caras/manos, antes/después fotográficos, testimonios con foto, badges de
...
4. `npm --prefix propuestas/abogado-b-azul-cian run build` (tsc --noEmit && vite build) hasta verde.
