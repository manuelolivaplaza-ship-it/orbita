    ...
    <>
      ...
      <section className="seccion" id="destacadas">
        <div className="seccion-cab">
          <Revelar>
            <p className="kicker">Tratamientos y servicios</p>
            <h2>
              Tratamientos que <em>marcan</em> la diferencia.
            </h2>
          </Revelar>
          <Revelar delay={120}>
            <Enlace a={rutas.catalogo} className="enlace-flecha">
              Ver los {propiedades.length} tratamientos →
            </Enlace>
          </Revelar>
        </div>
      ...
      <section className="seccion" id="servicios">
        <div className="seccion-cab">
          <Revelar>
            ...
            <h2>Cuatro formas de atenderle, un mismo estándar.</h2>
          </Revelar>
        </div>
      ...
      <section className="seccion" id="testimonios">
        <div className="seccion-cab">
          <Revelar>
            <p className="kicker">Cartas de pacientes</p>
      ...
      <section className="cinta-cta">
        <Revelar>
          <h2>
            ¿Agendamos su <em>hora</em>?
          </h2>
          <p>Primera evaluación con plan de tratamiento impreso el mismo día.</p>
          <div className="hero-ctas">
            <Btn a={rutas.captacion}>Agendar hora</Btn>
