# MEDIA-PLAN — contador-claro · Estudio Balance · contabilidad
> Generado con muse-spark-1.2-contributor (opencode-go) — prompts listos para Google Flow / FAL flux pro
> Fecha: 2026-08-28 · Workspace: propuestas/contador-claro

## Identidad
- Marca: Estudio Balance — Estudio Balance — Contabilidad al día, negocio en calma
- Sector: contabilidad — Estudio contable y tributario: orden, calma y servicios explicados sin jerga.
...
- Media actual en public/media/: archivo.png, escritorio.png, grilla.png, sala-reuniones.png (4 archivo(s) jpg/png)
...
4. `npm --prefix propuestas/contador-claro run build` (tsc --noEmit && vite build) hasta verde.
