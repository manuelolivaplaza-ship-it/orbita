# MEDIA-PLAN — arquitectura-b-claro · NORTE ESTUDIO · arquitectura
> Generado con muse-spark-1.2-contributor (opencode-go) — prompts listos para Google Flow / FAL flux pro
> Fecha: 2026-08-28 · Workspace: propuestas/arquitectura-b-claro

## Identidad
- Marca: NORTE ESTUDIO — NORTE ESTUDIO — Arquitectura · Propuesta Órbita
- Sector: arquitectura — Buen proyecto, obra corta, casa tranquila: sistema propio de módulos prefabricados de madera que se montan en semanas.
...
- Media actual en public/media/: detail.jpg, hero.jpg, model.jpg, site.jpg (4 archivo(s) jpg/png)
...
4. `npm --prefix propuestas/arquitectura-b-claro run build` (tsc --noEmit && vite build) hasta verde.
