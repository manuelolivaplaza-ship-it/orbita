# MEDIA-PLAN — inmobiliaria-claro · Meridiano Propiedades · inmobiliaria
> Generado con muse-spark-1.2-contributor (opencode-go) — prompts listos para Google Flow / FAL flux pro
> Fecha: 2026-08-28 · Workspace: propuestas/inmobiliaria-claro

## Identidad
- Marca: Meridiano Propiedades — Meridiano Propiedades — Propuesta de rediseño · Órbita
- Sector: inmobiliaria — Corredora inmobiliaria clara y minimalista: propiedades destacadas y contacto directo.
...
4. `npm --prefix propuestas/inmobiliaria-claro run build` (tsc --noEmit && vite build) hasta verde.
