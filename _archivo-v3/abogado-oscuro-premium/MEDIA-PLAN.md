# MEDIA-PLAN — abogado-oscuro-premium · Rivera & Cía. · legal
> Generado con muse-spark-1.2-contributor (opencode-go) — prompts listos para Google Flow / FAL flux pro
> Fecha: 2026-08-28 · Workspace: propuestas/abogado-oscuro-premium

## Identidad
- Marca: Rivera & Cía. — RIVERA & CÍA. — Abogados · Propuesta Órbita
- Sector: legal — Abogados con dirección oscura premium: autoridad y confianza desde la primera pantalla.
...
4. `npm --prefix propuestas/abogado-oscuro-premium run build` (tsc --noEmit && vite build) hasta verde.
