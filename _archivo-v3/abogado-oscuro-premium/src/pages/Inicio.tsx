    ...
    <>
      ...
      <section className="seccion" id="destacadas">
        <div className="seccion-cab">
          <Revelar>
            <p className="kicker">Áreas de práctica destacadas</p>
            <h2>
              Tres áreas que <em>definen</em> el estudio.
            </h2>
          </Revelar>
          <Revelar delay={120}>
            <Enlace a={rutas.catalogo} className="enlace-flecha">
              Ver las {propiedades.length} áreas →
            </Enlace>
          </Revelar>
        </div>
      ...
      <section className="seccion" id="testimonios">
        <div className="seccion-cab">
          <Revelar>
            ...
            <h2>Lo que dicen quienes firmaron con nosotros.</h2>
          </Revelar>
        </div>
      ...
      <section className="cinta-cta">
        <Revelar>
          <h2>
            ¿Conversamos sobre su <em>caso</em>?
          </h2>
          <p>Primera consulta de media hora sin costo, presencial o por video.</p>
          <div className="hero-ctas">
            <Btn a={rutas.captacion}>Solicitar una consulta</Btn>
