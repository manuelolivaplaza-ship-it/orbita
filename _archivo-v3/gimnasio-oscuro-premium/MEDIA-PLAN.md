# MEDIA-PLAN — gimnasio-oscuro-premium · FORJA · bienestar
> Generado con muse-spark-1.2-contributor (opencode-go) — prompts listos para Google Flow / FAL flux pro
> Fecha: 2026-08-28 · Workspace: propuestas/gimnasio-oscuro-premium

## Identidad
- Marca: FORJA — FORJA · Propuesta Órbita
- Sector: bienestar — Centro de entrenamiento con dirección oscura premium: fuerza, disciplina y comunidad.
...
- Media actual en public/media/: barra.png, pesas.png, plataforma.png, sala.png (4 archivo(s) jpg/png)
...
4. `npm --prefix propuestas/gimnasio-oscuro-premium run build` (tsc --noEmit && vite build) hasta verde.
